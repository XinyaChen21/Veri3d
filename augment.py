...
class AugmentPipe(torch.nn.Module):
    def __init__(self,
        ...
        noise=0, cutout=0, noise_std=0.1, cutout_size=0.5, pad_value=1
    ):
        super().__init__()
    ...
    def forward(self, _images, debug_percentile=None):
        ...
        if G_inv is not I_3:
            ...
            images = torch.nn.functional.pad(input=images, pad=[mx0,mx1,my0,my1], mode='constant', value=self.pad_value)
